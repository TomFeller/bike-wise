...
const useIncidentsService = (id?:number, pageIndex?: number) => {
    ...
    useEffect(() => {
        ...
        const url = id && id >= 0 ? `${api}/${id}` : `${api}?page=${pageIndex}&per_page=10&incident_type=theft&proximity=45.521728%2C-122.67326&proximity_square=100`;
        fetch(url)
